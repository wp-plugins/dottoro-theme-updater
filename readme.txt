...
= 1.7 =
* bug fix: the plugin doesn't save the service key in multisite

= 1.6 =
* bug fix: backslashes being removed when saving a post or page
...
= 1.3 =
* force check update feature added

= 1.2 =
* support for the new versions of Dottoro Theme
